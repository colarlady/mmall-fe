...
var config = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin(getHtmlPara("payment","订单支付")),
        new HtmlWebpackPlugin(getHtmlPara("order-confirm","订单确认")),
        new HtmlWebpackPlugin(getHtmlPara("order-list","我的订单")),
        new HtmlWebpackPlugin(getHtmlPara("order-detail","订单详情")),
